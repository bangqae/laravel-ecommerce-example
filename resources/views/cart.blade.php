            ...
            <div class="cart-table-row">
                <div class="cart-table-row-left">
                    ...
                    <div class="cart-item-details">
                        <div class="cart-table-item"><a class="cart-item-name"
                ...
                <div class="cart-table-row-right">
                    ...
                    {{-- Too many zero in rupiah, so I'm moving select quantity to top --}}
                    <div>
        ...
        <div class="cart-totals">
            ...
            <div class="cart-totals-right">
                ...
                <div class="cart-totals-subtotal">
                    {{ formatRupiah(Cart::subtotal()) }} <br>
                    {{ formatRupiah(Cart::tax()) }} <br>
                    <span class="cart-totals-total">{{ formatRupiah(Cart::total()) }}</span>
                </div>
            </div>
        </div> <!-- end cart-totals -->
